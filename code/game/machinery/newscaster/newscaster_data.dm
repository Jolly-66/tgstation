...
/datum/feed_network/New()
	create_feed_channel("Station Announcements", "PUBLIC", "Company news, staff annoucements, and all the latest information. Have a secure shift!", locked = TRUE, hardset_channel = 1000)
