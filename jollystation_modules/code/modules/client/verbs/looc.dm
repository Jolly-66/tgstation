...
/client/verb/looc(msg as text)
	...
	for(var/client/target in GLOB.clients)
		...
		if(target.prefs.toggles & CHAT_OOC)
			...
			if(send)
				to_chat(target, "<font color='[LOOC_SPAN_COLOR]'><b><span class='prefix'><font color='[LOOC_PREFIX_COLOR]'>LOOC[prefix]:</font> </span><EM>[display_admin? "[display_admin]" : "[display_name]"]:</EM> <span class='message'>[msg]</span></span></b></font>", type=MESSAGE_TYPE_LOCALCHAT)
