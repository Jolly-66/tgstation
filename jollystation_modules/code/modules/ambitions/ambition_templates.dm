...
/datum/ambition_template/boxpushing
	...
	tips = list("Circuit imprinters can be used to quickly manufacture more, and stock parts can be purchased at tool storage.", "Ideally, you won't just prime you grenades, wrap them, and send them through the pipes. Attach a remote signaller!")
...
/datum/ambition_template/legitjustkiurz
	...
	tips = list("Heroine Buds can be obtained through Xenobiology. You don't necessarily have to use the station's xenobio lab, either! Set up your own on Lavaland, steal a slime extract and some monkey cubes!")
